...
#SBATCH --output=experiments/natural_scenes_background_with_overlap_splitted/slurm_output.out
#SBATCH --error=experiments/natural_scenes_background_with_overlap_splitted/slurm_error.err
...
cd experiments/natural_scenes_background_with_overlap_splitted/scripts || exit 1
...
echo "End time: $(date)"
echo ""
echo "Results saved to: experiments/natural_scenes_background_with_overlap_splitted/"
