#!/bin/bash
#
# Complete natural_scenes_background_with_overlap_splitted experiment pipeline
#
...
echo "=========================================="
echo "Natural Scenes Background with Overlap - Pipeline"
echo "=========================================="
echo ""
echo "Experiment: natural_scenes_background_with_overlap_splitted"
