...
# --- SLURM CONFIGURATION ---
#SBATCH --job-name=yolo_solid_bg
#SBATCH --output=experiments/solid_background_splitted/slurm_output.out
#SBATCH --error=experiments/solid_background_splitted/slurm_error.err
...
echo "=========================================="
echo "YOLO Solid Background Experiment (SLURM)"
echo "=========================================="
...
cd experiments/solid_background_splitted/scripts || exit 1
...
echo ""
echo "=========================================="
echo "Phase 3: Generate Composite Images"
echo "=========================================="
...
echo "End time: $(date)"
echo ""
echo "Results saved to: experiments/solid_background_splitted/"
...
echo "  cat ../evaluation/evaluation_summary.json"
echo "  ls -lh ../evaluation/predictions/"
echo ""
