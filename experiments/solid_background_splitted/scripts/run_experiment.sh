#!/bin/bash
#
# Complete solid_background_splitted experiment pipeline
#
...
# echo "=========================================="
# echo "Solid Background Experiment Pipeline"
# echo "=========================================="
# echo ""
# echo "Experiment: solid_background_splitted"
...
# echo "----------------------------------------"
# echo "Step 3: Generate Composite Images"
# echo "----------------------------------------"
# if [ ! -d "../dataset/images/train" ] || [ -z "$(ls -A ../dataset/images/train 2>/dev/null)" ]; then
#     echo "Running generate_composite_images.py..."
...
echo "  - Read experiment README: cat ../README.md"
echo ""
