...
#SBATCH --output=experiments/line_background_with_overlap_splitted/slurm_output.out
#SBATCH --error=experiments/line_background_with_overlap_splitted/slurm_error.err
...
cd experiments/line_background_with_overlap_splitted/scripts || exit 1
...
echo "End time: $(date)"
echo ""
echo "Results saved to: experiments/line_background_with_overlap_splitted/"
