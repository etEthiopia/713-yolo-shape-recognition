#!/usr/bin/env python3
"""
Line Background with Overlap Experiment - Setup Script
...
EXPERIMENT_NAME = "line_background_with_overlap_splitted"
BASE_DIR = Path(__file__).parent.parent  # experiments/line_background_with_overlap_splitted/
...
def save_experiment_metadata():
    ...
    metadata = {
        "experiment_name": "Line Background with Overlap",
        ...
        "parameters": {
            ...
            "background_color": "striped lines (4 colors, 4 orientations)",
            "train_images": 1000,
            "test_images": 250,
            "image_size": 640,
            "epochs": 50,
...
def main():
    print("=" * 70)
    print("Line Background with Overlap Experiment - Setup")
    print("=" * 70)
    print()
