#!/bin/bash
#
# Complete line_background_with_overlap_splitted experiment pipeline
#
...
echo "=========================================="
echo "Line Background with Overlap - Pipeline"
echo "=========================================="
echo ""
echo "Experiment: line_background_with_overlap_splitted"
