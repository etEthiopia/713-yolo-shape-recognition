#!/usr/bin/env python3
"""
Solid Background with Overlap Experiment - Setup Script
...
EXPERIMENT_NAME = "solid_background_with_overlap_splitted"
BASE_DIR = Path(__file__).parent.parent  # experiments/solid_background_with_overlap_splitted/
...
def save_experiment_metadata():
    ...
    metadata = {
        "experiment_name": "Solid Background with Overlap",
...
def main():
    print("=" * 70)
    print("Solid Background with Overlap Experiment - Setup")
    print("=" * 70)
    print()
